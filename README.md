# A fazer:
- Criar o controle sobre o status do pedido de compras (para q o usuario nao consiga atualizar o payment method)
- Criar o controle sobre fotos para serem feitos upload: quantidade total esperada
